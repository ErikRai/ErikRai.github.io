$(function () {
  ...
  $('div.plain form')
    .submit(function () {
      const label = $('input[type="submit"]', this);
      const old_val = label.val();
  ...
  const plainTraceback = $('div.plain textarea');
...
function openShell (consoleNode, target, frameID) {
  ...
  consoleNode = $('<pre class="console">')
    ...
    .hide();
  let historyPos = 0, history = [''];
  const output = $('<div class="output">[console ready]</div>')
